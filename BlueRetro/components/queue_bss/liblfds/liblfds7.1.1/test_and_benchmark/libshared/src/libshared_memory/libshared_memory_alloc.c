...
/***** private prototypes *****/
static void *alloc_from_memory_element( struct libshared_memory_element *me, lfds711_pal_uint_t size_in_bytes, lfds711_pal_uint_t alignment_in_bytes );
...
/****************************************************************************/
void *libshared_memory_alloc_from_unknown_node( struct libshared_memory_state *ms, lfds711_pal_uint_t size_in_bytes, lfds711_pal_uint_t alignment_in_bytes )
{
  ...
  while( allocation == NULL and LFDS711_LIST_ASU_GET_START_AND_THEN_NEXT(ms->list_of_allocations,lasue) )
  {
...
/****************************************************************************/
void *libshared_memory_alloc_largest_possible_array_from_unknown_node( struct libshared_memory_state *ms, lfds711_pal_uint_t element_size_in_bytes, lfds711_pal_uint_t alignment_in_bytes, lfds711_pal_uint_t *number_elements )
{
  lfds711_pal_uint_t
    alignment_bump;
  ...
  // TRD : alignment_in_bytes can be any value in its range
  LFDS711_PAL_ASSERT( number_elements != NULL );
  ...
  */
  ...
  {
    temp_me = LFDS711_LIST_ASU_GET_VALUE_FROM_ELEMENT( *lasue );
  ...
  alignment_bump = (lfds711_pal_uint_t) me->current_pointer % alignment_in_bytes;
...
/****************************************************************************/
void *libshared_memory_alloc_from_specific_node( struct libshared_memory_state *ms, lfds711_pal_uint_t numa_node_id, lfds711_pal_uint_t size_in_bytes, lfds711_pal_uint_t alignment_in_bytes )
{
  struct lfds711_list_asu_element
    *lasue = NULL;
...
/****************************************************************************/
void *libshared_memory_alloc_from_most_free_space_node( struct libshared_memory_state *ms, lfds711_pal_uint_t size_in_bytes, lfds711_pal_uint_t alignment_in_bytes )
{
  struct lfds711_list_asu_element
    *lasue = NULL;
