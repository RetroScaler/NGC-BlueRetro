/***** defines *****/
#define LIBBENCHMARK_PRNG_MAX   ( (lfds711_pal_uint_t) -1 )
...
#if( LFDS711_PAL_ALIGN_SINGLE_POINTER == 4 ) // TRD : any 32-bit platform
  // TRD : struct LIBBENCHMARK_prng_state prng_state, lfds711_pal_uint_t seed
...
// TRD : 64-bit SplitMix, from Sebastiano vigna's site, CC0 license, http://xorshift.di.unimi.it/splitmix64.c
#if( LFDS711_PAL_ALIGN_SINGLE_POINTER == 8 ) // TRD : any 64-bit platform
  ...
  // TRD : struct libbenchmark_prng_state prng_state, lfds711_pal_uint_t random_value
  #define LIBBENCHMARK_PRNG_GENERATE( prng_state, random_value )                         \
  {                                                                                      \
