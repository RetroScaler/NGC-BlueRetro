...
void libbenchmark_topology_node_init( struct libbenchmark_topology_node_state *tns )
{
  ...
  lfds711_list_aso_init_valid_on_current_logical_core( &tns->logical_processor_children, libbenchmark_topology_node_compare_nodes_function, LFDS711_LIST_ASO_EXISTING_KEY_FAIL, NULL );
