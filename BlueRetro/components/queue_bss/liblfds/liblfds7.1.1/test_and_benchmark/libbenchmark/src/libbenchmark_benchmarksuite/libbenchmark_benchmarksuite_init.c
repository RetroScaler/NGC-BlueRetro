                                       ...
                                       lfds711_pal_uint_t benchmark_duration_in_seconds )
{
  ...
  lfds711_list_asu_init_valid_on_current_logical_core( &bss->benchmarksets, NULL );
  ...
  {
    // TRD : btree_au set
    bsets_btree_au = libshared_memory_alloc_from_most_free_space_node( ms, sizeof(struct libbenchmark_benchmarkset_state), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
    ...
    {
      bs = libshared_memory_alloc_from_most_free_space_node( ms, sizeof(struct libbenchmark_benchmarkinstance_state), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
    ...
    bs = libshared_memory_alloc_from_most_free_space_node( ms, sizeof(struct libbenchmark_benchmarkinstance_state), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
    libbenchmark_benchmarkinstance_init( bs, LIBBENCHMARK_DATASTRUCTURE_ID_BTREE_AU, LIBBENCHMARK_BENCHMARK_ID_READN_THEN_WRITEN, LIBBENCHMARK_LOCK_ID_LIBLFDS711_LOCKFREE, bss->ts, libbenchmark_benchmark_btree_au_liblfds711_lockfree_readn_writen_init, libbenchmark_benchmark_btree_au_liblfds711_lockfree_readn_writen_cleanup );
    libbenchmark_benchmarkset_add_benchmark( bsets_btree_au, bs );
  ...
  {
    // TRD : freelist set
    bsets_freelist = libshared_memory_alloc_from_most_free_space_node( ms, sizeof(struct libbenchmark_benchmarkset_state), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
    ...
    bs = libshared_memory_alloc_from_most_free_space_node( ms, sizeof(struct libbenchmark_benchmarkinstance_state), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
    libbenchmark_benchmarkinstance_init( bs, LIBBENCHMARK_DATASTRUCTURE_ID_FREELIST, LIBBENCHMARK_BENCHMARK_ID_PUSH1_THEN_POP1, LIBBENCHMARK_LOCK_ID_LIBLFDS711_LOCKFREE, bss->ts, libbenchmark_benchmark_freelist_liblfds711_lockfree_push1_pop1_init, libbenchmark_benchmark_freelist_liblfds711_lockfree_push1_pop1_cleanup );
    libbenchmark_benchmarkset_add_benchmark( bsets_freelist, bs );
  ...
  {
    // TRD : queue_umm set
    bsets_queue_umm = libshared_memory_alloc_from_most_free_space_node( ms, sizeof(struct libbenchmark_benchmarkset_state), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
    ...
    bs = libshared_memory_alloc_from_most_free_space_node( ms, sizeof(struct libbenchmark_benchmarkinstance_state), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
    libbenchmark_benchmarkinstance_init( bs, LIBBENCHMARK_DATASTRUCTURE_ID_QUEUE_UMM, LIBBENCHMARK_BENCHMARK_ID_ENQUEUE_UMM1_THEN_DEQUEUE_UMM1, LIBBENCHMARK_LOCK_ID_LIBLFDS711_LOCKFREE, bss->ts, libbenchmark_benchmark_queue_umm_liblfds711_lockfree_enqueue1_dequeue1_init, libbenchmark_benchmark_queue_umm_liblfds711_lockfree_enqueue1_dequeue1_cleanup );
    libbenchmark_benchmarkset_add_benchmark( bsets_queue_umm, bs );
