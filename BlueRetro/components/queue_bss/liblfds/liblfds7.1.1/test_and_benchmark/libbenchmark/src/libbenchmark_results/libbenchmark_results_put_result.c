                                      ...
                                      lfds711_pal_uint_t result )
{
  ...
  r = libshared_memory_alloc_from_most_free_space_node( rs->ms, sizeof(struct libbenchmark_result), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
  ...
  LFDS711_BTREE_AU_SET_KEY_IN_ELEMENT( r->baue, r );
  
  lfds711_btree_au_insert( &rs->results_tree, &r->baue, NULL );
