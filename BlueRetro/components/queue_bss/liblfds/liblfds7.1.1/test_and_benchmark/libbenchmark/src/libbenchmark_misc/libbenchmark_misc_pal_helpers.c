                                                     ...
                                                     struct libshared_memory_state *ms )
{
  ...
  *tns = libshared_memory_alloc_from_unknown_node( ms, sizeof(struct libbenchmark_topology_node_state), LFDS711_PAL_ATOMIC_ISOLATION_IN_BYTES );
                                                                          ...
                                                                          lfds711_pal_uint_t windows_processor_group_number )
{
  ...
  LFDS711_LIST_ASO_SET_KEY_IN_ELEMENT( tns_temp->lasoe, tns_temp );
  LFDS711_LIST_ASO_SET_VALUE_IN_ELEMENT( tns_temp->lasoe, tns_temp );
  lfds711_list_aso_insert( &tns->logical_processor_children, &tns_temp->lasoe, NULL );
