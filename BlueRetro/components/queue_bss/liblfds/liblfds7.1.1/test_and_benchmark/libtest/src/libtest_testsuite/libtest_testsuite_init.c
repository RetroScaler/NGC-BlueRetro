                             ...
                             void (*callback_test_finish)(char *result) )
{
  ...
  if( LFDS711_MISC_ATOMIC_SUPPORT_COMPILER_BARRIERS and LFDS711_MISC_ATOMIC_SUPPORT_PROCESSOR_BARRIERS and LFDS711_MISC_ATOMIC_SUPPORT_DWCAS )
  {
    ...
    libtest_test_init( &ts->tests[LIBTEST_TEST_ID_QUEUE_UMM_ENQUEUING_AND_DEQUEUING_ONE_ELEMENT], "Queue (unbounded, many producer, many consumer) enqueuing and dequeuing one element", LIBTEST_TEST_ID_QUEUE_UMM_ENQUEUING_AND_DEQUEUING_ONE_ELEMENT, libtest_tests_queue_umm_enqueuing_and_dequeuing_one_element );
    ...
    ts->test_available_flag[LIBTEST_TEST_ID_QUEUE_UMM_ENQUEUING_AND_DEQUEUING_ONE_ELEMENT] = RAISED;
